classdef movielong < handle
    ...
    methods
        %constructor
        function obj = movielong(pname, fname, first, last, sequence) % fname is the filename of the first fits-file
            ...
            if obj.input == 1 % tiff-stack
                ...
                obj.N_frame_per_fits = 30000; %obj.info{1}.PrimaryData.Size(3);
